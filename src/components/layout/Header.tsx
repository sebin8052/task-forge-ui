        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative max-w-md">
            ...
            <Input
              ...
              className="pl-10 w-80 bg-muted/50 border-muted focus:bg-background transition-colors"
            />
          </div>
        </div>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <DropdownMenuItem className="flex flex-col items-start gap-1 p-4">
                ...
                <div className="text-sm text-muted-foreground">You have been assigned to "Update user interface"</div>
                <div className="text-xs text-muted-foreground">2 minutes ago</div>
              </DropdownMenuItem>
              <DropdownMenuItem className="flex flex-col items-start gap-1 p-4">
                <div className="font-medium">Project milestone completed</div>
                <div className="text-sm text-muted-foreground">Website Redesign Phase 1 is now complete</div>
                <div className="text-xs text-muted-foreground">1 hour ago</div>
              </DropdownMenuItem>
              <DropdownMenuItem className="flex flex-col items-start gap-1 p-4">
                <div className="font-medium">Team member joined</div>
                <div className="text-sm text-muted-foreground">Sarah Johnson joined the Mobile App project</div>
